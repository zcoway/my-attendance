...
//)
public class RoleDataAction extends BaseAction{
	...
	private PageView<Role>pageView=new PageView<Role>();	//这里必须要构造新对象，不然刚打开没有currentPage参数传递过来，如果不新建也行，第一次打开必须传递currentPage参数过来
	...
	public String execute() throws Exception {
		...
		String[] excludes = {"users","resources"};
