...
<form id="editForm" name="editForm" action="message_update.action" method="post">
	<table>
		<tr>
			<td><span>接收者:</span></td>
			<td><input type="text" name="message.userReceiver" value="${message.receiverName }"/><label style="color: red;">*</label></td>
		</tr>
		<tr>
			<td><span>主题:</span></td>
			<td><input type="text" name="message.messageTitle" value="${message.messageTitle }"/><label style="color: red;">*</label></td>
		</tr>
		<tr>
			<td><span>内容:</span></td>
			<td><textarea cols="50" rows="5" name="message.messageContent">${message.messageContent}</textarea><label style="color: red;">*</label></td>
		</tr>	
