...
<title>基于SSH2框架的高校考勤考核管理系统</title>
	...
	<script type="text/javascript" src="${ctx}/js/resource_manager.js"></script>

<script type="text/javascript">
	function getAddUrl(){
		var url = "${ctx}/system/resource_add.action";
		return url;
	}
	function getDelUrl() {
		var url = "${ctx}/system/resource_delete.action";
		return url;
	}
...
<body class="easyui-layout">
	<div region="west" fit="auto" style="padding:2px;">
