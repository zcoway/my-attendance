...
<body>
<form id="addForm" name="addForm" action="resource_save.action" method="post">
	<table>
		<tr>
			<td><span>资源名称:</span></td>
			<td><input type="text" name="resource.resourceName" /><label style="color: red;">*</label></td>
			
			<td><span>资源类型:</span></td>
			<td><input type="text" name="resource.resourceType" /></td>
			
			
			<td><span>资源值:</span></td>
			<td><input type="text" name="resource.resourceValue" /><label style="color: red;">*</label></td>
			
		</tr>
		
		<tr>
			<td><span>父资源ID:</span></td>
			<td><input type="text" name="resource.resourceParentId" /><label style="color: red;">*</label></td>
		...
		<tr>	
			...
			<td><input type="text" name="resource.resourceDesc"/></td>
		</tr>
