...
<title>基于SSH2框架的高校考勤考核管理系统</title>
	...
	<script type="text/javascript" src="${ctx}/js/user_role_manager.js"></script>

<script type="text/javascript">
	function getAddUrl(){
		var url = "${ctx}/system/user_role_add.action";
		return url;
	}
	function getDelUrl() {
		var url = "${ctx}/system/user_role_delete.action";
		return url;
	}
...
<body class="easyui-layout">
	...
	<div region="west" border="false" split="true" fit="auto" style="width:550px;padding:2px;">
