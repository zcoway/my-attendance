...
<body>
<form id="addForm" name="addForm" action="clas_save.action" method="post">
	<table>
		<tr>
			<td><span>班级名称:</span></td>
			<td><input type="text" name="clas.clasName" /><label style="color: red;">*</label></td>
			
			<td><span>所属年级:</span></td>
			<td><input type="text" name="clas.clasGrade" /><label style="color: red;">*</label></td>
			
			<td><span>所属系部:</span></td>
			<td><input type="text" name="clas.clasDept" /><label style="color: red;">*</label></td>
		</tr>
		<tr>
			<td><span>班级描述:</span></td>
			<td><input type="text" name="clas.clasDesc" /></td>
		</tr>
