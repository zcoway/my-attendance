...
<body>
<form id="editForm" name="editForm" action="role_update.action" method="post">
	<table>
		<tr>
			<td><span>角色名称:</span></td>
			<td><input type="text" name="role.roleName" value="${role.roleName}"/><label style="color: red;">*</label></td>
			
			<td><span>角色描述:</span></td>
			<td><input type="text" name="role.roleDesc" value="${role.roleDesc}"/></td>
			
			<td><span>是否可用:</span></td>
			<td><s:radio name="role.roleEnabled" list="#{'true':'是','false':'否'}"/><label style="color: red;">*</label></td>
		</tr>
