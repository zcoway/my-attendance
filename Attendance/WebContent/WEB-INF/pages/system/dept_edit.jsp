...
<body>
<form id="editForm" name="editForm" action="dept_update.action" method="post">
	<table>
		<tr>
			<td><span>角色名称:</span></td>
			<td><input type="text" name="dept.deptName" value="${dept.deptName}"/><label style="color: red;">*</label></td>
			
			<td><span>角色描述:</span></td>
			<td><input type="text" name="dept.deptDesc" value="${dept.deptDesc}"/></td>
